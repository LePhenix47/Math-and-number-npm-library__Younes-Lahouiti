...
exports.solveQuadratic = exports.isPrime = exports.factorial = exports.logarithm = exports.nthRoot = void 0;
/**
...
function solveQuadratic(a, b, c) {
    ...
    if (hasOneRealSolution) {
        ...
        solutions_1.x1 = (-b + Math.sqrt(Math.abs(delta))) / (2 * a);
        solutions_1.x2 = (-b - Math.sqrt(Math.abs(delta))) / (2 * a);
        solutions_1.areReal = delta > 0;
    }
    return solutions;
}
